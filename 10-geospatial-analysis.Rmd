...
Ballarat <- getbb("Brisbane, australia", format_out = "sf_polygon")$multipolygon
...
This next paragraph involves the use of spatial random effects in regression models. Examples include conditional autoregressive (CAR) and intrinsic CAR 
(ICAR) 
