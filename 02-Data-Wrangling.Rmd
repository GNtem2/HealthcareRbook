...
Output from _RNiftyReg_ are _niftiImage_ object. They can be converted to _oro.nifti_ object using _nii2oro_ function.
...
ica1000.rescale<-RNiftyReg::rescale(ica1000,c(2,2,2))
...
There are several different MRI templates. The well known one is the MNI 152 template [@pmid11545704]. This was developed from male right-handed medical students.

#### AAL atlas

The automated anatomical labeling (AAL) atlas contains 45 volume of interest [@pmid11771995]. The atlas is aligned to MNI 152 coordinates.
