...
This is book based on **R Markdown** and **bookdown** (https://github.com/rstudio/bookdown). I have not updated this bookdown version any further.

I Have chosed to provide update using quarto document. The entire book can be accessed at (https://gntem2-q.quarto.pub/healthcare-r-book/). Since that time I have split it into several parts to make it even easier to write update.

Part 1 covers the basics of R and statististics. 
(https://gntem2-q.quarto.pub/healthcare-r-book-part1/).

Part 2 covers more advanced R such as multivariate and machine learning.
(https://gntem2-q.quarto.pub/healthcare-r-book-part-2/).
