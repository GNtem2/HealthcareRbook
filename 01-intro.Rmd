...
p1<-p+geom_errorbar(aes(ymin=Lower.95,ymax=Upper.95,width=0.2))+labs(y="R2 exaplained (%)")+
  theme(text=element_text(size=12))+ggtitle(" Relative Importance of Regressors \n Cost among patients with non-epileptic seizure")
p1
```
...
An alternative plot is to use _patchwork_ library.
...
```{r gantt}
library(tidyverse)
gantt_df<-data.frame(item=seq(1:4), activity=c("Ethics submission","Length","Recruitment","Follow up"),category=c("Ethics","Duration","Recruitment","Follow up"),Start=c("2020-06-01","2021-01-01","2021-01-01","2022-01-01"),End=c("2021-01-01","2023-01-01","2022-01-01","2023-01-01"))
...
The _ggtree_ library is available on Bioconductor, not CRAN. It is a package for visualisation of tree and annotation of data. The steps for installing this library is provided here. Here we illustrates _ggtree_ [@10.1111/2041-210x.12628] with data from _phyloseq_ [@10.1371/journal.pone.0061217]. 

This example shown here is taken from https://www.r-bloggers.com/ggtree-for-microbiome-data/.
